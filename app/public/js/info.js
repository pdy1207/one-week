$(document).ready(function () {
  ...
  ========================= */
    ...
    $birth.on('input', function () {
        ...
        if (v.length >= 5) {
            formatted = v.substring(0, 4) + '-' + v.substring(4, 6) + '-' + v.substring(6, 8);
        } else if (v.length >= 3) {
  ...
  ========================= */
    ...
    $phone.on('input', function () {
        ...
        if (v.length < 4) {
            ...
            formatted = v.substring(0, 3) + '-' + v.substring(3, 7) + '-' + v.substring(7, 11);
        }
  ...
  ========================= */
    ...
    const $addrError = $('<div class="text-danger small mt-1 d-none" id="addr_error">주소를 모두 입력해주세요.</div>');
